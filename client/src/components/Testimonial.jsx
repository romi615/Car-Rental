  ...
  const testimonials = [
    {
      ...
      testimonial:
        "I've rented cars from various companies, but the experience with CarRental was truly exceptional.",
    },
    {
      name: "John Smith",
  ...
  return (
    <div className="py-28 px-6 md:px-16 lg:px-14 xl:px-44">
      <Title
        ...
        subTitle="Discover why discerning travelers choose Stay venture for their luxury accommodations around the world."
      />
